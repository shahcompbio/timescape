...
#' library("timescape")
#' # genotype tree edges
#' tree_edges <- read.csv(system.file("extdata", "tree_edges.csv", package = "timescape"))
#' # clonal prevalences
#' clonal_prev <- read.csv(system.file("extdata", "clonal_prev.csv", package = "timescape"))
#' # targeted mutations
#' mutations <- read.csv(system.file("extdata", "mutations.csv", package = "timescape"))
#' # perturbations
